...
//export const PRIMARY_COLOR = '#4B72FB';
export const PRIMARY_COLOR = '#4B46E6';
//export const PRIMARY_COLOR = '#547feb';
export const PRIMARY_TEXT = '#424242';
//export const PRIMARY_COLOR = '#466BF9';
//export const PRIMARY_COLOR = '#69aa9f';
export const SECONDARY_COLOR = '#666666';
export const TERTIARY_COLOR = '#979797';
...
//export const BACKGROUND_PRIMARY_DARK = '#27272c';
export const BACKGROUND_PRIMARY_DARK = '#262A34';
export const BACKGROUND_PRIMARY_LIGHT = '#ffffff';
