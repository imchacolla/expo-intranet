...
const Home = ({ navigation }) => {
  ...
  const getPasajerosTipo = async () => {
    ...
    const response = await axios.get(`/pasajeros/lineasgestiontipo-app/${gestion}/${line}`);
  ...
  return (
    ...
    <SafeAreaView
      ...
      <ScrollView
        ...
        {queryReport.isLoading || queryPasajerosTipo.isLoading || queryCumplimiento.isLoading ?
          (
            <View
              style={{
            ...
            <View>
              <View>
                ...
                <View style={{
                  ...
                  <View
                    ...
                    <Text style={{
                      ...
                      {getYearTitle()} {getMonthTitleCumplimiento()} / Linea: {nameLine}
                    </Text>
                    <EchartGauge
                      isDarkMode={isDarkMode}
                ...
                <View style={{
                  ...
                  <EchartPie data={queryPasajerosTipo.data} isDarkMode={isDarkMode} />
                </View>
              </View>
            </View>
          )}
